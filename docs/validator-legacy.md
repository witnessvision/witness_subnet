# Legacy synthetic validator (scorer 1.1.0)

This page preserves the earlier synthetic workflow. For current signed MP4 rounds,
Luna evaluation and the separate weight writer, use [Validator setup](validator.md).
The commands below do not start production MP4 5.2.
